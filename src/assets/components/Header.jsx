...
export default function  Header({dashLink ,setDashLink}) {
  ...
  style={{ color: '#DC6B19', border: 'none', background: 'none', padding: '0', font: 'inherit', cursor: 'pointer' }} 
...
>
  Dashboard
                        ...
                        <li>
                            <a href="/faq" style={{ color: '#DC6B19' }} className="text-sm font-semibold hover:text-gray-900">FAQs</a>
                        </li>
                        <li>
                            <a href="/aboutUs" style={{ color: '#DC6B19' }} className="text-sm font-semibold hover:text-gray-900">About Us</a>
                        </li>
                    </ul>
                </div>
