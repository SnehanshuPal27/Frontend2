...
export function CustomerManage({ customerData, setCustomerData }) {
    ...
    const handleDelete = async (item) => {
        ...
        try {
            ...
            await axios.delete(
                `http://localhost:3000/api/customers/${item.CustomerID}`,
        ...
        <>
            <section className="mx-auto w-full max-w-8xl px-4 py-4">
                <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
                    <div>
                        <h2 className="text-lg font-semibold">Customer Manager</h2>
                                    ...
                                    <tbody className="divide-y divide-gray-200 bg-white">
                                        {customerList.map((item) => (
                                            <tr key={item.id}>
                                                ...
                                                <td className="whitespace-nowrap px-12 py-4 max-w-[10-rem]">
                                                    <div className="text-sm text-gray-900 break-all">{item.ContactNumber}</div>
